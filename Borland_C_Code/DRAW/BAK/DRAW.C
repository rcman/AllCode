	...
	if (hc == 1 && lc == 27)   // ESC Key & Exit
		...
		hc=0;lc=0;
			...
			if (hc == 74 && lc == 45)        // '-' Moved down 1 object
			{
			 ...
			 // nextshape(&fshp[spritenum],16, 16);
			 placeshape(&fshp[0],16, 16);
			 // clearshape(&fshp[spritenum],16, 16);
			 // cleargrid(&fshp[spritenum+1],16, 16);
			  //Draw_Data_to_Grid(&fshp[spritenum],16,16);
			 ...
			 // drawshape(&fshp[0],16, 16);
				...
				nextshape(&fshp[spritenum],16, 16);
				clearshape(&fshp[spritenum],16, 16);
				cleargrid(&fshp[spritenum],16, 16);
				Draw_Data_to_Grid(&fshp[spritenum],16,16);
